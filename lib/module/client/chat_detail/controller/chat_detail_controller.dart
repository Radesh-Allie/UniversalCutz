...
class ChatDetailController extends GetxController {
  ...
  updateReadStatus(Map<String, dynamic> item) async {
    bool isNotMe = item["sender"] != AppSession.currentUser.uid;
  ...
  sendMessage() async {
    ...
    // showLoading();
    await chatRef.add({
      "sender": AppSession.currentUser.uid,
      "message": message,
      "unread": true,
    ...
    var userDataRef =
        FirebaseFirestore.instance.collection(collection.userDataCollection).doc(receiverId);
